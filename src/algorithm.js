let algorithm = (function (){
    ...
    class ClosestPair {
        constructor(elements){
            ...
            minimal_distance = this.divideAndConquer(elements);
        }

        // O(n)
        getPointsOrderedByY(minX, maxX, allPointsOrderedByY) {
        ...
        getCandidates(orderedByY, validXInterval) {
        ...
        // O(n * 15) = O(n)
        getClosestPairInIntersection(points) {
        ...
        // O(3n) = O(n)
        combine(left, right, closestOnLeft, closestOnRight) {
        ...
        divideAndConquer(points) {
          return this.getClosestPairOrdered({
